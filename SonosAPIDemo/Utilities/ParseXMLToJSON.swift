...
final class ParseXMLToJSON {
    ...
    func parseXML() -> String? {
        ...
        let  jsonObject = try? xmlDoc.object(byApplyingXSLTString: xml2json, arguments: nil)
...
/* Following xslt is from: https://github.com/JayDaley/XML-to-JSON-in-XSLT
 ...
 To the extent possible under law, Jay Daley has waived all copyright and related or neighbouring rights to this work. This work is published from: New Zealand. This software is distributed without any warranty.

 For more information see the CC0 Public Domain Dedication.
 
*/
private let xml2json = """
